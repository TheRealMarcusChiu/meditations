...
(window.PRAYERS = window.PRAYERS || []).push({
  ...
  body:
`Me:
- me to know the truth and spend time with you
...
- Peter feel direct impact (would you want to make the greatest impact but not be able to see it, or the smallest impact and be able to see it)
- Chris struggle with purpose in work
...
- Tim as he figures out the questions of work (Every Good Endeavor)
- Will to find treasure in your word over the things under the sun
- Lydia to not worry or identity in work
